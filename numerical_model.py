...
"""
NUMERICAL MODEL:
this code includes the aircraft model (symmetric and asymmetric motion).
...
given = np.array([5.084 , 0.04, 0.8, -1.1642, -0.5626, -8.79415, -5.66290])
# C
class ac:
    def __init__(self, m=5579.791, deriv=given, initial=np.array([0.,0.,0.,0.]), hp0=5000, V0=100):
    ...
    # Aerodynamic properties
        ...
        self.CZu, self.CZa, self.CZadot, self.CZq, self.CZde = -0.37616, -5.74340, -0.00350, deriv[6], -0.69612

        self.Cmu, self.Cmadot, self.Cmq = +0.06990, 0.17800, deriv[5] #0.17800
