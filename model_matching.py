from numerical_model import ac
import numpy as np
import matplotlib.pyplot as plt
from data_process import short_data
import seaborn as sns

"""
MODEL MATCHING FOR SYMMETRIC MOTION: 
In this script, the coefficients are altered to make a closer match between the numerical model and the flight data.
