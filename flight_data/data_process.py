...
def symplot(mode):
    ...
    cond = np.array([m0, h0, V0, t0, u0, a0, th0, q0])
    return cond, tplot, uplot, aplot, thplot, qplot, deplot
...
def asymplot(mode):
    ...
    cond = np.array([m0, h0, V0, t0, beta0, phi0, p0, r0])
    return cond, tplot, phiplot, rplot, pplot, daplot, drplot

short_period_data = symplot(short)
phugoid_data = symplot(phugoid)
dutch_roll_data = asymplot(dutch)
dutch_roll_yawdamp_data = asymplot(dutch_yawdamp)
aperiodic_roll_data = asymplot(aperiodic)
